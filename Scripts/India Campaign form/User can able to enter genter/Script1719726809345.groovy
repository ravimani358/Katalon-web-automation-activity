...
WebUI.verifyElementPresent(findTestObject('Campaign form/India campaign form/Page_indiatestcampaign1/button_Verify Email'),
	3)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Campaign form/Campaign mobile number/Page_indiatestcampaign1/button_Verify Phone'),
	3)

WebUI.click(findTestObject('Object Repository/Campaign form/Enter gender/Page_indiatestcampaign1/span_Select an Option'))

WebUI.click(findTestObject('Object Repository/Campaign form/Enter gender/Page_indiatestcampaign1/span_Male'))
