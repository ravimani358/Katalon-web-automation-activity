...
WebUI.setText(findTestObject('Object Repository/17 New Test case creation/2nd Test case/Page_OrangeHRM/input_Username_username'), 
    'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/17 New Test case creation/2nd Test case/Page_OrangeHRM/input_Password_password'), 
    'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.click(findTestObject('Object Repository/17 New Test case creation/2nd Test case/Page_OrangeHRM/button_Login'))

WebUI.click(findTestObject('Object Repository/17 New Test case creation/2nd Test case/Page_OrangeHRM/span_Recruitment'))
...
WebUI.click(findTestObject('Object Repository/17 New Test case creation/2nd Test case/Page_OrangeHRM/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/17 New Test case creation/2nd Test case/Page_OrangeHRM/h6_Candidate History'), 
    0)
